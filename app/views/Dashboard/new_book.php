...
<div class="card mb-4">
  ...
  <form class="card-body" action="/dashboard/save_book" method="POST" enctype='multipart/form-data'>
    
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">Name</label>
        <input name="name" type="text" id="multicol-username" class="form-control" placeholder="book name" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">Price</label>
        <div class="input-group input-group-merge">
          <input  name="price" type="number" id="multicol-email" class="form-control"   aria-describedby="multicol-email2" />
          
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-password">image</label>
          <div class="input-group input-group-merge">
            <input  name="uploadfile" type='file'  id="multicol-password" class="form-control" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="multicol-password2" />
            </div>
        </div>
      </div>
      <!-- <div class="col-md-6">
        <label class="form-label" for="multicol-username">Description</label>
        <input name="description" type="text"  class="form-control" placeholder="book description" />
      </div>

      <div class="col-md-6">
        <label class="form-label" for="multicol-email">pages number</label>
        <div class="input-group input-group-merge">
      ...
      <div class="col-md-6">
        ...
        <div class="input-group input-group-merge">
          <input  name="quantity" type="number" id="multicol-email" class="form-control"   aria-describedby="multicol-email2" />
        </div>
      </div>
      ...
      <div class="col-md-6">
        ...
        <div class="input-group input-group-merge">
          <input  name="format" type="text" id="multicol-email" class="form-control"   aria-describedby="multicol-email2" />
        </div>
      </div>
      ...
      <div class="col-md-6">
        ...
        <div class="input-group input-group-merge">
          <input  name="created_by" type="text" id="multicol-email" class="form-control"   aria-describedby="multicol-email2" />
        </div>
      </div>

      <div class="col-md-6">
        <label class="form-label" for="multicol-email">created at</label>
        <div class="input-group input-group-merge">
          <input  name="created_at" type="date" id="multicol-email" class="form-control"   aria-describedby="multicol-email2" />
        </div>
      </div>

      <div class="col-md-6">
        <label class="form-label" for="multicol-email">updated at</label>
        <div class="input-group input-group-merge">
          <input  name="updated_at" type="date" id="multicol-email" class="form-control"   aria-describedby="multicol-email2" />
        </div>
      </div> -->
